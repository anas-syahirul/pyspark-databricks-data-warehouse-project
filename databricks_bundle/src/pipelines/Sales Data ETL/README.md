...
This folder defines all source code for the 'Sales Data ETL' pipeline:
...
* Take a look at the sample under "sample_users_sales_data_etl.py" to get familiar with the syntax.
